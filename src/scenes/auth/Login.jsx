    ...
    try {
      ...
      if (data.status === 200) {
        ...
        if (loginCount === "0") {
          ...
          setErrors({
            isError: true,
            description: "No Spaces Found for this User",
          });
        } else {
    ...
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: "100vh" }}>
        ...
        >
          ...
          >
            "Streamline your operations and enhance security across all spaces
            with our comprehensive admin portal."
          </Typography>
        </Grid>
        <Grid
          item
